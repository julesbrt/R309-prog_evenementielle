...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        grid.addWidget(self.__lab, 0, 0, 1, 2)
        grid.addWidget(self.__text, 1, 0, 1, 2)
        grid.addWidget(self.__ok, 3, 0, 1, 1)
        grid.addWidget(self.__name, 2, 0, 1, 2)
        grid.addWidget(self.__quit, 3, 1, 1, 1)
